...
const seedDatabase = async () => {
    ...
    await Promise.all([
        ...
        Document_1.default.deleteMany({}),
        DocumentChunk_1.default.deleteMany({}),
        LearningPlan_1.default.deleteMany({}),
        LearningTask_1.default.deleteMany({}),
        Quiz_1.default.deleteMany({}),
        QuizAttempt_1.default.deleteMany({}),
        Conversation_1.default.deleteMany({}),
        Message_1.default.deleteMany({}),
        Memory_1.default.deleteMany({}),
        StudySession_1.default.deleteMany({}),
    ]);
    ...
    const courseOS = await Course_1.default.create({
        userId: user._id,
    ...
    const courseML = await Course_1.default.create({
        userId: user._id,
    ...
    const uploadDir = config_1.default.uploadDir;
    if (!fs_1.default.existsSync(uploadDir))
        fs_1.default.mkdirSync(uploadDir, { recursive: true });
    const sampleFilePath = path_1.default.join(uploadDir, 'Operating_Systems_Chapter_4_Synchronization.md');
    fs_1.default.writeFileSync(sampleFilePath, SAMPLE_DOCUMENT_TEXT, 'utf-8');
    const extraction = await (0, textExtractor_1.extractTextFromFile)(sampleFilePath, 'md');
    const chunks = (0, chunker_1.chunkDocument)(extraction.pages, {
        chunkSize: 800,
        chunkOverlap: 120,
        documentId: new mongoose_1.default.Types.ObjectId().toString(),
        documentName: 'Process Synchronization & Deadlocks Notes.md',
        courseId: courseOS._id.toString(),
        userId: user._id.toString(),
    });
    const embeddings = await (0, embeddings_1.generateBatchEmbeddings)(chunks.map((c) => c.content));
    const document = await Document_1.default.create({
        ...
        storedFileName: path_1.default.basename(sampleFilePath),
    ...
    await LearningTask_1.default.insertMany(sampleTasks);
    ...
    await QuizAttempt_1.default.create({
        quizId: quiz._id,
        userId: user._id,
        courseId: courseOS._id,
        answers: [
